...
<head>
    ...
    <link rel="shortcut icon" href="https://lab.chinapnr.com/data/bankCard/favicon.ico">
            ...
            <div class="min-width">
                ...
                <div class="main">
                    <div class="content">
                        ...
                        <form method="post" action="https://lab.chinapnr.com/data/bankCard/bankcard/addCard"
                              autocomplete="off"
                                    ...
                                    <dl class="form-list form-list-no-icon">
                                        <dd>
                                            <div class="form-group">
                                                ...
                                                <span class="form-text" id="rname" name="rname"></span>
                                            </div>
                                            <div class="form-group">
                                                <label id="userNo" class="label">证件号码:</label>
                                                <span class="form-text" id="idno" name="idno" ></span>
                                            </div>
                                        </dd>
                                        <dd>
                                                ...
                                                <div class="form-group">
                                                    <label class="label">所属银行:</label>
                                                            <input placeholder="请输入所属银行"  class="form-unit" id="type"  name="type" required="" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"   class="form-unit" id="cardno" name="cardno"
                                                           required=""
...
<script>
    try {
        var t = jQuery;
        document.write("<script type='text/javascript' src='/data/bankCard/scripts/jQuery.md5.js'><\/script>");
    } catch (e) {
        document.write("<script type='text/javascript' src='/data/bankCard/scripts/zepto.md5.js'><\/script>");
    }
</script>
