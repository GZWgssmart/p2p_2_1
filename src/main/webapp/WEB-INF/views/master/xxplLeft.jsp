...
<div class="about-left">
    <div class="about-left-nav">
        ...
        <ul class="sub-nav">
            ...
            <li id="gd" class=""><a href="#gdbj" class="icon-about about-gudong">股东背景</a></li>
            ...
            <li class="active"><a href="#ptgg" class="icon-about about-gonggao">平台公告</a></li>
            <li class=""><a href="#zxns" class="icon-about about-zhaopin">招贤纳士</a></li>
