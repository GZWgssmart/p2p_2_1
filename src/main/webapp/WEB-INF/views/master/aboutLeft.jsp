    ...
    <div class="about-left-nav">
        <div id="animateDiv" class="animateDiv" style="height: 175px;">
            <ul id="animateUl" class="sub-nav">
                <li class="xxpl">
                    <a href="javaScript:void(0);" onclick="animate1()" class="icon-about about-xxpl">信息披露</a>
                </li>
                <li class="cyjg active">
                    <a href="#cyjg" class="icon-about about-cyjg">从业机构信息</a>
                </li>
                <li class="ptyy">
                    <a href="#ptyy" class="icon-about about-ptyy">平台运营信息</a>
                </li>
                <li class="jkxm">
                    <a href="#jkxm" class="icon-about about-jkxm">借款项目信息</a>
                </li>
            </ul>
        </div>
        <ul class="sub-nav">
