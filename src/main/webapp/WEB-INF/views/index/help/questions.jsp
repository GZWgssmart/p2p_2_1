        ...
        <div class="layui-tab layui-tab-brief">
            ...
            <div class="layui-tab-content" style="height: 100%;">
                <div class="layui-tab-item layui-show ">
                    <div class="layui-collapse">
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">本金和收益是否可以得到保障？</h2>
                            <div class="layui-colla-content">
                                <p>普金资本推荐的产品中包含的借款项目，以及多金宝项目均是通过多重审核机构审核，外加借款方连带担保责任，充分保障投资人本金及投资收益。</p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">普金资本是合法的运营网站吗？</h2>
                            <div class="layui-colla-content">
                                <p> 普金资本是由国资委牵头参股搭建的互联网金融平台，属于合法运营的网站。</p>
                                <br>
                                <a href="http://www.gzctgroup.cn/">赣州城投发展有限公司</a><br>
                                <a href="https://credit.szfw.org/CX20160720023638001698.html">诚信网站认证</a><br>
                                <a href="http://gsxt.saic.gov.cn/">工商企业信用信息查询：全国企业信用信息网</a>。查询时请输入公司名称“普金资本运营（赣州）有限公司”
                                <br>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">如何保障我资金安全？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">网上交易保障中心是什么？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    投资成功之后，也是由第三方支付公司汇付天下把钱打给借款人，资金从保管账户转入借款人账户后会在网上交易保障中心生成一份电子回单。这份电子回单类似于银行转账汇款单一样，有”电子签名“和“时间戳”，保障并确认资金的最终流向，让投资人对自己的每笔资金都能清楚了解在什么时间，转给了谁。
                                </p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">隐私和资料安全如何保障？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    尊重用户个人隐私是本网站的一项基本原则，普金资本郑重承诺在任何情况下都绝不会出售、出租或以任何其他形式泄露您的信息。同时，普金资本在数据加密及操作流程上对用户的隐私信息进行严密的保护。普金资本是一个实名认证平台，用户在平台上交流的过程中，也需要时刻注意保护个人隐私，截图注意覆盖个人信息，不要随意透露真实姓名与住址等，以防信息被盗造成损失。
                                </p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">在普金资本投资是否受到法律保护？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    投资人在普金资本的投资理财受到法律保护，普金资本提供的是居间服务，通俗的说，普金资本提供的是平台服务，法律根据有《合同法》和《关于人民法院审理借贷案件的若干意见》。
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-tab-item">
                    <div class="layui-collapse">
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">充值流程</h2>
                            <div class="layui-colla-content">
                                先登录账户，可自由选择多个入口进行充值，登录后在首页上方点击“充值”→快速进入充值界面；或者登录后在首页直接点击“我的账户”，也可直接进入充值界面。<br>
                                <img alt="充值图片" src="<%=path %>/static/images/help/flow_01.png"><br>
                                进入充值界面，输入“充值金额”→点击“立即充值”，根据界面所示，选择相应的充值方式及银行卡,即可完成充值。<br>
                                <img alt="充值图片" src="<%=path %>/static/images/help/flow_02.png">
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">提现操作</h2>
                            <div class="layui-colla-content">
                                <p>
                                    1、登录个人账户，进入“我的账户”，点击“提现”；如下图界面所示<br>
                                    <img alt="提现图片" src="<%=path %>/static/images/help/flow_03.png"><br>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">投资流程</h2>
                            <div class="layui-colla-content">
                                <p>
                                    步骤一：登录www.pujinziben.com，选择要购买的项目，输入购买金额，点击【立即投标】<br>
                                    <img alt="投资图片" src="<%=path %>/static/images/help/flow_04.png"><br>
                                    步骤二，确认购买信息，如信息无误，请点击【确认】完成购买
                                </p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">银行卡绑定</h2>
                            <div class="layui-colla-content">
                                <p>
                                    1、登录个人账户，进入“我的账户”，点击“我的银行卡”→“添加银行卡”；进入界面<br>
                                    <img alt="银行卡绑定图片" src="<%=path %>/static/images/help/flow_05.png"><br>
                                    2、确认用户真实姓名；<br>
                                    3、选择所属银行及银行卡所属地；<br>
                                    4、填写银行卡号汇付交易密码；<br>
                        ...
                        <div class="layui-colla-item">
                            ...
                            <div class="layui-colla-content">
                                <p>
                                    ...
                                    <img alt="账户安全设置" src="<%=path %>/static/images/help/flow_06.png"><br>
                                    2、根据提示完善邮箱绑定、身份认证、及交易密码设置。
                                </p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">忘记登录密码怎么办？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    在登录页面选择“忘记密码”进行重置，通过用户已经绑定的手机号码进行找回。<br>
                                    <img alt="忘记登录密码" src="<%=path %>/static/images/help/flow_07.png"><br>
                                </p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">注册流程</h2>
                            <div class="layui-colla-content">
                                <p>
                                    登录www.pujinziben.com，进入普金资本首页，点击首页右上方的【注册】，进入注册页面,根据提示输入用户名、登录密码→获取验证码→同意注册条款，然后点击【注册】<br>
                                    <img alt="注册流程" src="<%=path %>/static/images/help/flow_08.png"><br>
                                </p>
                            </div>
                        </div>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">转让操作</h2>
                            <div class="layui-colla-content">
                                <p>
                                    1、登录个人账户，进入“我的账户”→左侧菜单栏选择“债权管理”→“可转让”；如下图如示：<br>
                                    <img alt="转让操作" src="<%=path %>/static/images/help/flow_09.png"><br>
                                    2、点击“债权转让”进入转让设置<br>
                                    <img alt="债权转让" src="<%=path %>/static/images/help/flow_10.png"><br>
                ...
                <div class="layui-tab-item">
                    <div class="layui-collapse">
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">充值时开户不成功应该如何解决？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">充值收费吗？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">如何充值？普金资本支持信用卡充值吗？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">提现失败是什么原因？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    （1）账户未绑定银行卡。<br>
                                    （2）提现金额超过账户可用余额。<br>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">提现收费吗？提现的额度有限制吗？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">提现需要多久到账？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    暂不收取，普金资本将为客户垫付充值手续费，实现客户充值零费用。
                                </p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">提现需要注意哪些问题？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">为什么我的账户资金不能投资也不能提现？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">为什么银行已扣款，但平台账户余额没有增加？</h2>
                            <div class="layui-colla-content">
                                <p>
                ...
                <div class="layui-tab-item">
                    <div class="layui-collapse">
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">等额本息的还款方式有哪些优点？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">借款项目出现逾期或坏账怎么处理？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">普金资本目前产品有哪几类？收益率为多少？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">普金资本目前的还款方式有哪些？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">投资成功后什么时候开始计息？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    满标审核后开始计息。
                                </p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">投资成功后是否可以撤销？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    所有项目在购买成功后均不可以撤销。
                                </p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">投资的起始金额为多少？</h2>
                            <div class="layui-colla-content">
                                <p>
                                    普金资本项目最低投资金额为100元。
                                </p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">投资资金有限制吗？</h2>
                            <div class="layui-colla-content">
                                <p>
                ...
                <div class="layui-tab-item">
                    <div class="layui-collapse">
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">为什么实名认证通不能通过？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">为什么要进行实名登记？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">一个手机号可以注册几个账号？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">注册成功后用户名可以修改吗？</h2>
                            <div class="layui-colla-content">
                                <p>
                        ...
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">注册时手机收不到验证码怎么办？</h2>
                            <div class="layui-colla-content">
                                <p>
