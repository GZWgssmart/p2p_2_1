                    ...
                    <div class="about-content">
                        <div class="tableDiv">
                            <div class="textItem">
                                ...
                                <img class="xmjsImg" src="<%=path %>/static/images/help/hengjin.png" alt="恒金保" width="900">
                            </div>
                            <div class="fgx"></div>
                            <div class="textItem">
                                ...
                                <img class="xmjsImg" src="<%=path %>/static/images/help/pujin.png" alt="普金保" width="900">
                            </div>
                            <div class="fgx"></div>
                            <div class="textItem">
                                ...
                                <center><img class="xmjsImg" src="<%=path %>/static/images/help/duojin.png" alt="多金保" width="550"></center>
                            </div>
                        </div>
                    </div>
                </div>
