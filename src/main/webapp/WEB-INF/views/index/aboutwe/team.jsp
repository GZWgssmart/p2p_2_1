    ...
    <div class="account-right">
        ...
        <div class="layui-tab layui-tab-card">
            <ul class="layui-tab-title">
                <li class="layui-this">法律顾问</li>
                <li>律师事务所</li>
            </ul>
            <div class="layui-tab-content" style="width: 900px">
                <div class="layui-tab-item layui-show">
                    <div id="falv" class="content" style="display: block;">
                        <div class="content-photo">
                            <div class="content-photo-left">
                                <img src="<%=path %>/static/images/about/guwen_01.png">
                                <p class="name">赖华明</p>
                ...
                <div class="layui-tab-item">
                    <div id="shiwu" class="content">
                        ...
                        <img class="img" src="<%=path %>/static/images/about/shiwu_03.png">
                    </div>
                </div>
            </div>
        </div>
