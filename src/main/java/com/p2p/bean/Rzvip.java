...
public class Rzvip {
    ...
    public Rzvip(Integer rzid, Integer uid, String xl, String ism, String bschool, String addr, String work, Integer age, Integer resint1, Integer resint2, String resstr1, String resstr2) {
        this.rzid = rzid;
        this.uid = uid;
        this.xl = xl;
        this.ism = ism;
